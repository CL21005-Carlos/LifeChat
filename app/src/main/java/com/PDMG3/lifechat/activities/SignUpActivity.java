...
import com.PDMG3.lifechat.databinding.ActivitySignUpBinding;
...
public class SignUpActivity extends AppCompatActivity {
    ...
    private Boolean isValidSignUpDatails(){
        if (encodedImage == null){
            ...
            showToast("Ingresar imagen valida");
            return false;
        }else if (binding.inputPassword.getText().toString().trim().isEmpty()) {
            showToast("Ingresar Clave");
            return false;
        }else if (binding.inputConfirmPassword.getText().toString().trim().isEmpty()) {
            showToast("Confirmar la clave ");
            return false;
        }else if (!binding.inputPassword.getText().toString().equals(binding.inputConfirmPassword.getText().toString())) {
            showToast("Clave y la confirmacion de clave no es la misma");
            return false;
        }else {
            return true;
        }
